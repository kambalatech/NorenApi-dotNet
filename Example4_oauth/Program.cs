...
{    
    public static class Program
    {
        ...
        public const string dob = "1998";
        public const string imei = "";
        public const string client_id = "LEVELUP_U";
        
        public const string secretcode = "LnsPWQSbTpP1m6Pk1CUUp2buyOr3eUrwLbwE6hiU7wPNRgHIH1Q0DiRNlOo0VrS9";
        public const string newpwd = "@1newAbcd1234";
        #endregion
        ...
        static void Main(string[] args)
        {
            ...
            var apikey_url = nApi.SendgetOAuthURL(oauth_url, client_id);

            Console.WriteLine(apikey_url);

            OpenUrl(apikey_url.ToString());
            Console.WriteLine("Enter the Auth Code:");
            var auth_code = Console.ReadLine();
